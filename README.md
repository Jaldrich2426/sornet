...
```
Note that since the PROPS Pose dataset automatically augments its images you may experince slightly less percieved accuracy in some cases depending on the scene augmentation. 
